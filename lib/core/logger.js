...
exports.redirectLog = exports.LogTypeMap = exports.PluginLogger = exports.AnemoLogger = exports.Devices = void 0;
...
exports.AnemoLogger = log4js_1.default.getLogger('anemo');
...
log4js_1.default.addLayout('anemo', (config) => {
...
/** 重定向 oicq 日志输出到日志文件 */
function redirectLog(anemoLogLevel = 'info', oicq_config, account) {
    const { platform = 5, log_level: oicqLogLevel } = oicq_config;
    // 定义输出文件名和路径
    const now = (0, dayjs_1.default)().format('YYYY-MM-DD_HH-mm-ss');
    const filename = `Anemo_${now}_${account}_${exports.Devices[platform]}`;
