...
export declare const AnemoLogger: log4js.Logger;
...
/** 重定向 oicq 日志输出到日志文件 */
export declare function redirectLog(anemoLogLevel: string | undefined, oicq_config: Config, account: number): void;
