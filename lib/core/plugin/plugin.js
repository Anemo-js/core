...
class AnemoPlugin extends node_events_1.default {
    /**
     * Anemo 插件类
     *
    ...
    throwPluginError(message) {
        throw new pluginError_1.AnemoPluginError(this.name, message);
    }
    /**
     ...
     */
    async mountAnemoClient(bot, admins) {
     ...
     * @param {AdminArray} admins 框架管理员列表
     */
    async unmountAnemoClient(bot, admins) {
...
exports.AnemoPlugin = AnemoPlugin;
