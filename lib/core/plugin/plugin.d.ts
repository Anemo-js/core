...
export declare class AnemoPlugin extends EventEmitter {
    /** 插件名称 */
    name: string;
    /** 插件版本 */
    version: string;
     ...
     */
    mountAnemoClient(bot: Client, admins: AdminArray): Promise<AnemoPlugin>;
    /**
     * **插件请勿调用**，Anemo 框架调用此函数禁用插件
     * @param {Client} bot oicq Client 实例
     * @param {AdminArray} admins 框架管理员列表
     */
    unmountAnemoClient(bot: Client, admins: AdminArray): Promise<void>;
    /**
