...
const package_json_1 = require("oicq/package.json");
...
插件: 启用 ${start_1.plugins.size} 个，共 ${cnts.all} 个
...
协议: oicq-v${package_json_1.version}-${logger_1.Devices[bot.config.platform]}
...
`.trim();
    ...
    // ]
    // // 防止消息刷屏，采用合并转发
    // const xml = await makeForwardMsg.bind(bot)(msgs, 'Anemo 状态', '点击查看 Anemo 运行状态')
    return message;
}
