...
const start = () => {
    ...
    try {
        ...
        console.log(utils_1.title);
        console.log('使用文档: ' + utils_1.colors.green('https://anemo-docs.pages.dev/'));
        console.log('框架版本: ' + utils_1.colors.green(`anemo-core ${exports.pkg.version}`));
